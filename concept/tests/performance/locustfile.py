...
Scenarios loaded:
  ...
  - TaskManagementUser      (weight 3) — create, update, assign, and delete tasks
  - ProjectCreationUser     (weight 1) — create new projects
  - CommentManagementUser   (weight 2) — post, edit, and delete comments
"""
