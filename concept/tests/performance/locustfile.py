...
Scenarios loaded:
  ...
  - TaskLifecycleUser   (weight 2) — create, edit, assign and delete a task
  - CommentLifecycleUser(weight 1) — post, edit and delete an own comment
  - ProjectCreationUser (weight 1) — create a project and open its detail view
"""
