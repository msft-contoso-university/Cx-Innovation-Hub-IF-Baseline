...
Scenarios loaded:
  ...
  - TaskLifecycleUser   (weight 3) — create, edit, assign and delete a task
  - CommentModerationUser (weight 2) — edit and delete own comments
  - ProjectAdminUser    (weight 1) — create new projects
"""
