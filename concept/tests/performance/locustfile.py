...
Scenarios loaded:
  ...
  - TaskManagementUser    (weight 2) — create, update, assign, and delete tasks
  - ProjectManagementUser (weight 1) — create projects
  - CommentManagementUser (weight 1) — post, edit, and delete comments
"""
