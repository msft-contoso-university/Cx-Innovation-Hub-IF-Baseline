...
Scenarios loaded:
  ...
  - ProjectManagementUser  (weight 1) — create new projects
  - TaskManagementUser     (weight 2) — full task lifecycle (create/update/assign/delete)
  - CommentManagementUser  (weight 1) — edit and delete own comments
"""
