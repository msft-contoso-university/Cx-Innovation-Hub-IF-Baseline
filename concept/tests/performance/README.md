...
| **Project Creation** | 2 | Creates new projects via `POST /api/projects` to validate write performance |
| **User Directory** | 3 | Lists users and views a random user profile |
